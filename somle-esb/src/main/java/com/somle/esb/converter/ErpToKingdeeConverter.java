...
//        }
     ...
     */
    public List<KingdeeProduct> convertCustomRules(List<ErpCustomRuleDTO> allProducts) {
     ...
     */
    public List<KingdeeProduct> convertProducts(List<ErpProductDTO> allProducts) {
