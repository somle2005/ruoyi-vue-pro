...
public class CreateItemAndSkuRequest extends BaseRequest {
   ...
   public void setAttributes(List<UpdateItemV3Request.ItemAttribute> attributes) {
   ...
   public void setCreateSkuList(List<Sku> createSkuList) {
      this.createSkuList = createSkuList;
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof CreateItemAndSkuRequest)) {
         return false;
      } else {
         CreateItemAndSkuRequest other = (CreateItemAndSkuRequest)o;
         if (!other.canEqual(this)) {
            ...
            Object this$createSkuList = this.getCreateSkuList();
            Object other$createSkuList = other.getCreateSkuList();
            if (this$createSkuList == null) {
               if (other$createSkuList != null) {
                  return false;
               }
            } else if (!this$createSkuList.equals(other$createSkuList)) {
               return false;
            }
   ...
   protected boolean canEqual(Object other) {
      return other instanceof CreateItemAndSkuRequest;
   }
   ...
   public int hashCode() {
      ...
      Object $createSkuList = this.getCreateSkuList();
      result = result * 59 + ($createSkuList == null ? 43 : $createSkuList.hashCode());
   ...
   public String toString() {
      return "CreateItemAndSkuRequest(name=" + this.getName() + ", ename=" + this.getEname() + ", brandId=" + this.getBrandId() + ", categoryId=" + this.getCategoryId() + ", attributes=" + this.getAttributes() + ", shippingTemplateId=" + this.getShippingTemplateId() + ", shippingGrossWeight=" + this.getShippingGrossWeight() + ", variantIds=" + this.getVariantIds() + ", images=" + this.getImages() + ", standardImages=" + this.getStandardImages() + ", longImages=" + this.getLongImages() + ", videos=" + this.getVideos() + ", articleNo=" + this.getArticleNo() + ", imageDescriptions=" + this.getImageDescriptions() + ", transparentImage=" + this.getTransparentImage() + ", description=" + this.getDescription() + ", deliveryMode=" + this.getDeliveryMode() + ", freeReturn=" + this.getFreeReturn() + ", enableMultiWarehouse=" + this.getEnableMultiWarehouse() + ", sizeTableImage=" + this.getSizeTableImage() + ", recommendSizeTableImage=" + this.getRecommendSizeTableImage() + ", modelTryOnSizeTableImage=" + this.getModelTryOnSizeTableImage() + ", enableMainSpecImage=" + this.getEnableMainSpecImage() + ", createSkuList=" + this.getCreateSkuList() + ", enableStepPresale=" + this.getEnableStepPresale() + ", itemShortTitle=" + this.getItemShortTitle() + ")";
   }
   ...
   public static class Material {
      ...
      public String toString() {
         return "CreateItemAndSkuRequest.Material(link=" + this.getLink() + ")";
      }
   }
   ...
   public static class ItemAttribute {
      ...
      public String toString() {
         return "CreateItemAndSkuRequest.ItemAttribute(propertyId=" + this.getPropertyId() + ", name=" + this.getName() + ", value=" + this.getValue() + ", valueId=" + this.getValueId() + ", valueList=" + this.getValueList() + ")";
      }
   }
   ...
   public static class AttributeValue {
      ...
      public String toString() {
         return "CreateItemAndSkuRequest.AttributeValue(valueId=" + this.getValueId() + ", value=" + this.getValue() + ")";
      }
   }
   ...
   public static class Variant {
      ...
      public String toString() {
         return "CreateItemAndSkuRequest.Variant(id=" + this.getId() + ", name=" + this.getName() + ", value=" + this.getValue() + ", valueId=" + this.getValueId() + ")";
      }
   }
   ...
   public static class DeliveryTime {
      ...
      public String toString() {
         return "CreateItemAndSkuRequest.DeliveryTime(time=" + this.getTime() + ", type=" + this.getType() + ")";
      }
   }
}
