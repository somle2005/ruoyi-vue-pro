...
public class CreateSkuV3Request extends BaseRequest {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof CreateSkuV3Request)) {
         return false;
      } else {
         CreateSkuV3Request other = (CreateSkuV3Request)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof CreateSkuV3Request;
   }
   ...
   public static class VariantV3 {
      ...
      public String toString() {
         return "CreateSkuV3Request.VariantV3(id=" + this.getId() + ", name=" + this.getName() + ", value=" + this.getValue() + ", valueId=" + this.getValueId() + ")";
      }
   }
   ...
   public static class DeliveryTimeV3 {
      ...
      public String toString() {
         return "CreateSkuV3Request.DeliveryTimeV3(time=" + this.getTime() + ", type=" + this.getType() + ")";
      }
   }
}
