...
public class FlsGetItemInfoRequest extends BaseRequest {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof FlsGetItemInfoRequest)) {
         return false;
      } else {
         FlsGetItemInfoRequest other = (FlsGetItemInfoRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof FlsGetItemInfoRequest;
   }
   ...
   public String toString() {
      return "FlsGetItemInfoRequest(pageSize=" + this.getPageSize() + ", pageNo=" + this.getPageNo() + ", itemId=" + this.getItemId() + ")";
   }
}
