...
public class GetWarehouseResponse {
   ...
   public List<WarehouseCoverage> coverageList;
   ...
   public List<WarehouseCoverage> getCoverageList() {
   ...
   public void setCoverageList(List<WarehouseCoverage> coverageList) {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof GetWarehouseResponse)) {
         return false;
      } else {
         GetWarehouseResponse other = (GetWarehouseResponse)o;
         if (!other.canEqual(this)) {
            ...
            Object this$coverageList = this.getCoverageList();
            Object other$coverageList = other.getCoverageList();
            if (this$coverageList == null) {
               if (other$coverageList != null) {
                  return false;
               }
            } else if (!this$coverageList.equals(other$coverageList)) {
               return false;
            }
   ...
   protected boolean canEqual(Object other) {
      return other instanceof GetWarehouseResponse;
   }
   ...
   public int hashCode() {
      ...
      Object $coverageList = this.getCoverageList();
      result = result * 59 + ($coverageList == null ? 43 : $coverageList.hashCode());
      return result;
   }

   public String toString() {
      return "GetWarehouseResponse(code=" + this.getCode() + ", name=" + this.getName() + ", province=" + this.getProvince() + ", provinceCode=" + this.getProvinceCode() + ", city=" + this.getCity() + ", cityCode=" + this.getCityCode() + ", area=" + this.getArea() + ", areaCode=" + this.getAreaCode() + ", town=" + this.getTown() + ", townCode=" + this.getTownCode() + ", address=" + this.getAddress() + ", contactName=" + this.getContactName() + ", contactTel=" + this.getContactTel() + ", coverageList=" + this.getCoverageList() + ")";
   }

   public static class WarehouseCoverage {
      public String province;
      public String provinceCode;
      public String city;
      public String cityCode;
      ...
      public boolean equals(Object o) {
         if (o == this) {
            return true;
         } else if (!(o instanceof WarehouseCoverage)) {
            return false;
         } else {
            WarehouseCoverage other = (WarehouseCoverage)o;
            if (!other.canEqual(this)) {
               return false;
            } else {
               Object this$province = this.getProvince();
      ...
      protected boolean canEqual(Object other) {
         return other instanceof WarehouseCoverage;
      }
      ...
      public String toString() {
         return "GetWarehouseResponse.WarehouseCoverage(province=" + this.getProvince() + ", provinceCode=" + this.getProvinceCode() + ", city=" + this.getCity() + ", cityCode=" + this.getCityCode() + ", area=" + this.getArea() + ", areaCode=" + this.getAreaCode() + ")";
      }
   }
}
