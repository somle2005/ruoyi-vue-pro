...
public class FlsSkuDetail {
   private String id;
   private String scSkucode;
   private boolean buyable;
   private List<UnionItemResultV3> unionItemDetails;
   ...
   public List<UnionItemResultV3> getUnionItemDetails() {
   ...
   public void setUnionItemDetails(List<UnionItemResultV3> unionItemDetails) {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof FlsSkuDetail)) {
         return false;
      } else {
         FlsSkuDetail other = (FlsSkuDetail)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof FlsSkuDetail;
   }
   ...
   public String toString() {
      return "FlsSkuDetail(id=" + this.getId() + ", scSkucode=" + this.getScSkucode() + ", buyable=" + this.isBuyable() + ", unionItemDetails=" + this.getUnionItemDetails() + ", createTime=" + this.getCreateTime() + ", updateTime=" + this.getUpdateTime() + ", name=" + this.getName() + ", isGift=" + this.getIsGift() + ", itemId=" + this.getItemId() + ", ipq=" + this.getIpq() + ", originalPrice=" + this.getOriginalPrice() + ", price=" + this.getPrice() + ", stock=" + this.getStock() + ", logisticsPlanId=" + this.getLogisticsPlanId() + ", whcode=" + this.getWhcode() + ", priceType=" + this.getPriceType() + ", erpCode=" + this.getErpCode() + ", variants=" + this.getVariants() + ", deliveryTime=" + this.getDeliveryTime() + ", specImage=" + this.getSpecImage() + ", barcode=" + this.getBarcode() + ", originSkuId=" + this.getOriginSkuId() + ", boutiqueMode=" + this.getBoutiqueMode() + ", images=" + this.getImages() + ", imageDescriptions=" + this.getImageDescriptions() + ", description=" + this.getDescription() + ", faqs=" + this.getFaqs() + ", freeReturn=" + this.getFreeReturn() + ", memberPrice=" + this.getMemberPrice() + ", taxType=" + this.getTaxType() + ")";
   }
   ...
   public static class VariantV3 {
      ...
      public String toString() {
         return "FlsSkuDetail.VariantV3(id=" + this.getId() + ", name=" + this.getName() + ", value=" + this.getValue() + ", valueId=" + this.getValueId() + ")";
      }
   }
   ...
   public static class DeliveryTimeV3 {
      ...
      public String toString() {
         return "FlsSkuDetail.DeliveryTimeV3(time=" + this.getTime() + ", type=" + this.getType() + ")";
      }
   }
   ...
   public static class Faq {
      ...
      public String toString() {
         return "FlsSkuDetail.Faq(question=" + this.getQuestion() + ", answer=" + this.getAnswer() + ")";
      }
   }

   public static class UnionItemResultV3 {
      public String id;
      public String name;
      ...
      public boolean equals(Object o) {
         if (o == this) {
            return true;
         } else if (!(o instanceof UnionItemResultV3)) {
            return false;
         } else {
            UnionItemResultV3 other = (UnionItemResultV3)o;
            if (!other.canEqual(this)) {
               return false;
            } else if (this.getIpq() != other.getIpq()) {
               return false;
            } else if (Double.compare(this.getRatio(), other.getRatio()) != 0) {
               return false;
            } else {
               Object this$id = this.getId();
               Object other$id = other.getId();
      ...
      protected boolean canEqual(Object other) {
         return other instanceof UnionItemResultV3;
      }
      ...
      public String toString() {
         return "FlsSkuDetail.UnionItemResultV3(id=" + this.getId() + ", name=" + this.getName() + ", scSkuCode=" + this.getScSkuCode() + ", barcode=" + this.getBarcode() + ", ipq=" + this.getIpq() + ", erpCode=" + this.getErpCode() + ", ratio=" + this.getRatio() + ")";
      }
   }
}
