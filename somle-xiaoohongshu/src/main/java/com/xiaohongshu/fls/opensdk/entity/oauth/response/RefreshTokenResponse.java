...
public class RefreshTokenResponse {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof RefreshTokenResponse)) {
         return false;
      } else {
         RefreshTokenResponse other = (RefreshTokenResponse)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof RefreshTokenResponse;
   }
   ...
   public String toString() {
      return "RefreshTokenResponse(accessToken=" + this.getAccessToken() + ", accessTokenExpiresAt=" + this.getAccessTokenExpiresAt() + ", refreshToken=" + this.getRefreshToken() + ", refreshTokenExpiresAt=" + this.getRefreshTokenExpiresAt() + ", sellerId=" + this.getSellerId() + ", sellerName=" + this.getSellerName() + ")";
   }
}
