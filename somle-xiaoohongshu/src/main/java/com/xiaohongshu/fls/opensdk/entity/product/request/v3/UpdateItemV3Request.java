...
public class UpdateItemV3Request extends BaseRequest {
   private String id;
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof UpdateItemV3Request)) {
         return false;
      } else {
         UpdateItemV3Request other = (UpdateItemV3Request)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof UpdateItemV3Request;
   }
   ...
   public static class ItemAttribute {
      ...
      public String toString() {
         return "UpdateItemV3Request.ItemAttribute(propertyId=" + this.getPropertyId() + ", name=" + this.getName() + ", value=" + this.getValue() + ", valueId=" + this.getValueId() + ", valueList=" + this.getValueList() + ")";
      }
   }
   ...
   public static class AttributeValue {
      ...
      public String toString() {
         return "UpdateItemV3Request.AttributeValue(valueId=" + this.getValueId() + ", value=" + this.getValue() + ")";
      }
   }
   ...
   public static class Faq {
      ...
      public String toString() {
         return "UpdateItemV3Request.Faq(question=" + this.getQuestion() + ", answer=" + this.getAnswer() + ")";
      }
   }
}
