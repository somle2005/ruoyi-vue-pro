...
public class SyncSkuStockV2Response {
   private Response response;
   private String apiVersion;
   private SkuStockInfo skuStockInfo;
   private Map<String, SkuStockInfoWithWhcode> data;
   ...
   public Map<String, SkuStockInfoWithWhcode> getData() {
      return this.data;
   }
   ...
   public void setData(Map<String, SkuStockInfoWithWhcode> data) {
      this.data = data;
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof SyncSkuStockV2Response)) {
         return false;
      } else {
         SyncSkuStockV2Response other = (SyncSkuStockV2Response)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof SyncSkuStockV2Response;
   }
   ...
   public String toString() {
      return "SyncSkuStockV2Response(response=" + this.getResponse() + ", apiVersion=" + this.getApiVersion() + ", skuStockInfo=" + this.getSkuStockInfo() + ", data=" + this.getData() + ")";
   }
   ...
   public static class Response {
      ...
      public String toString() {
         return "SyncSkuStockV2Response.Response(success=" + this.isSuccess() + ", msg=" + this.getMsg() + ", code=" + this.getCode() + ")";
      }
   }
   ...
   public static class SkuStockInfo {
      ...
      public String toString() {
         return "SyncSkuStockV2Response.SkuStockInfo(skuId=" + this.getSkuId() + ", skuStockInfo=" + this.getSkuStockInfo() + ")";
      }
   }
   ...
   public static class SkuStockInfoWithWhcode {
      ...
      public String toString() {
         return "SyncSkuStockV2Response.SkuStockInfoWithWhcode(skuId=" + this.getSkuId() + ", whcode=" + this.getWhcode() + ", skuStockInfo=" + this.getSkuStockInfo() + ")";
      }
   }
}
