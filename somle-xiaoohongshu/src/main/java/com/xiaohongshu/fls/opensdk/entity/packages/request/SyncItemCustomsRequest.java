...
public class SyncItemCustomsRequest extends BaseRequest {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof SyncItemCustomsRequest)) {
         return false;
      } else {
         SyncItemCustomsRequest other = (SyncItemCustomsRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof SyncItemCustomsRequest;
   }
   ...
   public String toString() {
      return "SyncItemCustomsRequest(barcode=" + this.getBarcode() + ", customsName=" + this.getCustomsName() + ", hsCode=" + this.getHsCode() + ", generalTaxRate=" + this.getGeneralTaxRate() + ", quantity1=" + this.getQuantity1() + ", quantity2=" + this.getQuantity2() + ")";
   }
}
