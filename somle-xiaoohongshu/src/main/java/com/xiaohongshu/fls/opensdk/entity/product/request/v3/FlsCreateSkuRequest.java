...
public class FlsCreateSkuRequest extends BaseRequest {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof FlsCreateSkuRequest)) {
         return false;
      } else {
         FlsCreateSkuRequest other = (FlsCreateSkuRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof FlsCreateSkuRequest;
   }
   ...
   public static class VariantV3 {
      ...
      public String toString() {
         return "FlsCreateSkuRequest.VariantV3(id=" + this.getId() + ", name=" + this.getName() + ", value=" + this.getValue() + ", valueId=" + this.getValueId() + ")";
      }
   }
   ...
   public static class DeliveryTimeV3 {
      ...
      public String toString() {
         return "FlsCreateSkuRequest.DeliveryTimeV3(time=" + this.getTime() + ", type=" + this.getType() + ")";
      }
   }
   ...
   public static class Faq {
      ...
      public String toString() {
         return "FlsCreateSkuRequest.Faq(question=" + this.getQuestion() + ", answer=" + this.getAnswer() + ")";
      }
   }
}
