...
public class UpdateSpuRequest extends BaseRequest {
   private String id;
   private String name;
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof UpdateSpuRequest)) {
         return false;
      } else {
         UpdateSpuRequest other = (UpdateSpuRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof UpdateSpuRequest;
   }
   ...
   public String toString() {
      return "UpdateSpuRequest(id=" + this.getId() + ", name=" + this.getName() + ", ename=" + this.getEname() + ", shortName=" + this.getShortName() + ", brandId=" + this.getBrandId() + ", categoryId=" + this.getCategoryId() + ", attributes=" + this.getAttributes() + ", shippingTemplateId=" + this.getShippingTemplateId() + ", shippingGrossWeight=" + this.getShippingGrossWeight() + ", variantIds=" + this.getVariantIds() + ", imageUrls=" + this.getImageUrls() + ", videoUrl=" + this.getVideoUrl() + ", articleNo=" + this.getArticleNo() + ", imageDescUrls=" + this.getImageDescUrls() + ", transparentImageUrl=" + this.getTransparentImageUrl() + ", desc=" + this.getDesc() + ", faqs=" + this.getFaqs() + ", isChannel=" + this.getIsChannel() + ", deliveryMode=" + this.getDeliveryMode() + ", updatedFields=" + this.getUpdatedFields() + ", freeReturn=" + this.getFreeReturn() + ")";
   }
   ...
   public static class SpuAttribute {
      ...
      public String toString() {
         return "UpdateSpuRequest.SpuAttribute(propertyId=" + this.getPropertyId() + ", name=" + this.getName() + ", value=" + this.getValue() + ", valueId=" + this.getValueId() + ", valueList=" + this.getValueList() + ")";
      }
   }
   ...
   public static class AttributeValue {
      ...
      public String toString() {
         return "UpdateSpuRequest.AttributeValue(valueId=" + this.getValueId() + ", value=" + this.getValue() + ")";
      }
   }
   ...
   public static class Faq {
      ...
      public String toString() {
         return "UpdateSpuRequest.Faq(question=" + this.getQuestion() + ", answer=" + this.getAnswer() + ")";
      }
   }
}
