...
public class FlsCreateItemRequest extends BaseRequest {
   private String name;
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof FlsCreateItemRequest)) {
         return false;
      } else {
         FlsCreateItemRequest other = (FlsCreateItemRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof FlsCreateItemRequest;
   }
   ...
   public String toString() {
      return "FlsCreateItemRequest(name=" + this.getName() + ", ename=" + this.getEname() + ", brandId=" + this.getBrandId() + ", categoryId=" + this.getCategoryId() + ", attributes=" + this.getAttributes() + ", shippingTemplateId=" + this.getShippingTemplateId() + ", shippingGrossWeight=" + this.getShippingGrossWeight() + ", variantIds=" + this.getVariantIds() + ", video=" + this.getVideo() + ", articleNo=" + this.getArticleNo() + ", transparentImage=" + this.getTransparentImage() + ", isChannel=" + this.getIsChannel() + ", deliveryMode=" + this.getDeliveryMode() + ", freeReturn=" + this.getFreeReturn() + ")";
   }
   ...
   public static class ItemAttribute {
      ...
      public String toString() {
         return "FlsCreateItemRequest.ItemAttribute(propertyId=" + this.getPropertyId() + ", name=" + this.getName() + ", value=" + this.getValue() + ", valueId=" + this.getValueId() + ", valueList=" + this.getValueList() + ")";
      }
   }
   ...
   public static class AttributeValue {
      ...
      public String toString() {
         return "FlsCreateItemRequest.AttributeValue(valueId=" + this.getValueId() + ", value=" + this.getValue() + ")";
      }
   }
}
