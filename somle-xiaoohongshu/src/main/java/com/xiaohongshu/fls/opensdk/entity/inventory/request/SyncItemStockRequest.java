...
public class SyncItemStockRequest extends BaseRequest {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof SyncItemStockRequest)) {
         return false;
      } else {
         SyncItemStockRequest other = (SyncItemStockRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof SyncItemStockRequest;
   }
   ...
   public String toString() {
      return "SyncItemStockRequest(itemId=" + this.getItemId() + ", qty=" + this.getQty() + ")";
   }
}
