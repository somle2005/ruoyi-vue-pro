...
public enum SrmEventEnum {
    ...
    COMPLETE_PAYMENT("完成付款"), CANCEL_PAYMENT("取消付款"), PAYMENT_EXCEPTION("付款异常"), PAYMENT_ADJUSTMENT("付款调整"),

    //退款事件
    RETURN_INIT("退款初始化"), RETURN_ADJUSTMENT("退款调整"), RETURN_CANCEL("取消退款"), RETURN_EXCEPTION("退款异常"), //退款完成
    RETURN_COMPLETE("退款完成"),

    //入库事件
    STORAGE_INIT("入库初始化"), STOCK_ADJUSTMENT("库存调整"), //    PARTIAL_STORAGE("部分入库"),
