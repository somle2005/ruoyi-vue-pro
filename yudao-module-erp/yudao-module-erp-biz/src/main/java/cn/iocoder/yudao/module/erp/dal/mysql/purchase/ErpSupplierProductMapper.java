...
public interface ErpSupplierProductMapper extends BaseMapperX<ErpSupplierProductDO> {
    ...
    default List<ErpSupplierProductDO> selectListByProductId(ErpSupplierProductPageReqVO pageReqVO){
        return selectList(new LambdaQueryWrapperX<ErpSupplierProductDO>()
            .eqIfPresent(ErpSupplierProductDO::getProductId, pageReqVO.getProductId())
            .eqIfPresent(ErpSupplierProductDO::getSupplierId, pageReqVO.getSupplierId()));
    }
}