...
public class ErpCustomRuleCategoryItemController {
    ...
    public CommonResult<Long> createCustomRuleCategoryItem(@Valid @RequestBody ErpCustomRuleCategoryItemSaveReqVO createReqVO) {
    ...
    public CommonResult<Boolean> updateCustomRuleCategoryItem(@Valid @RequestBody ErpCustomRuleCategoryItemSaveReqVO updateReqVO) {
