...
public interface ErrorCodeConstants {
    ...
    ErrorCode PRODUCT_CODE_DUPLICATE = new ErrorCode(1_030_500_002, "产品SKU（编码）已存在");
    ErrorCode DEPT_LEVEL_NOT_MATCH = new ErrorCode(1_030_500_003, "部门等级不符合要求，只允许二级部门和三级部门上传");
