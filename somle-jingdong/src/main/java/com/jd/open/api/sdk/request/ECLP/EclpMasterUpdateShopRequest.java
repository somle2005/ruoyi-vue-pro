...
import com.jd.open.api.sdk.response.ECLP.EclpMasterUpdateShopResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class EclpMasterUpdateShopRequest extends AbstractRequest implements JdRequest<EclpMasterUpdateShopResponse> {
   ...
   public Class<EclpMasterUpdateShopResponse> getResponseClass() {
      return EclpMasterUpdateShopResponse.class;
   }
}
