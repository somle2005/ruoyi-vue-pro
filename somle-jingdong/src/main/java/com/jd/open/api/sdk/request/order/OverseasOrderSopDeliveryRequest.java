...
public class OverseasOrderSopDeliveryRequest extends AbstractRequest implements JdRequest<OverseasOrderSopDeliveryResponse> {
   ...
   public Class<OverseasOrderSopDeliveryResponse> getResponseClass() {
      return OverseasOrderSopDeliveryResponse.class;
   }
