...
import com.jd.open.api.sdk.response.promotion.SellerCouponReadGetCouponCountResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class SellerCouponReadGetCouponCountRequest extends AbstractRequest implements JdRequest<SellerCouponReadGetCouponCountResponse> {
   private String ip;
   private String port;
   ...
   public Class<SellerCouponReadGetCouponCountResponse> getResponseClass() {
      return SellerCouponReadGetCouponCountResponse.class;
   }
}
