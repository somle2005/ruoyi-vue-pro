...
import com.jd.open.api.sdk.response.shangjiashouhou.AscUnsolvedMessageListResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscUnsolvedMessageListRequest extends AbstractRequest implements JdRequest<AscUnsolvedMessageListResponse> {
   private String buId;
   ...
   public Class<AscUnsolvedMessageListResponse> getResponseClass() {
      return AscUnsolvedMessageListResponse.class;
   }
}
