...
import com.jd.open.api.sdk.response.iopdz.ConvertFourAreaByDetailStrResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class ConvertFourAreaByDetailStrRequest extends AbstractRequest implements JdRequest<ConvertFourAreaByDetailStrResponse> {
   ...
   public Class<ConvertFourAreaByDetailStrResponse> getResponseClass() {
      return ConvertFourAreaByDetailStrResponse.class;
   }
}
