...
public class EclpGoodsTransportGoodsInfoRequest extends AbstractRequest implements JdRequest<EclpGoodsTransportGoodsInfoResponse> {
   ...
   public void setLargeCargoTransport(String largeCargoTransport) {
   ...
   public void setBoxLevelNo(Byte boxLevelNo) {
      this.boxLevelNo = boxLevelNo;
   }

   public Byte getBoxLevelNo() {
      return this.boxLevelNo;
   }

   public void setBoxLevelName(String boxLevelName) {
      this.boxLevelName = boxLevelName;
   }

   public String getBoxLevelName() {
      return this.boxLevelName;
   }
   ...
   public void setBillingSpecs(Integer billingSpecs) {
      this.billingSpecs = billingSpecs;
   }

   public Integer getBillingSpecs() {
   ...
   public String getAppJsonParams() throws IOException {
      ...
      pmap.put("safeDays", this.safeDays);
      pmap.put("instoreThreshold", this.instoreThreshold);
      pmap.put("outstoreThreshold", this.outstoreThreshold);
      pmap.put("serial", this.serial);
      ...
      pmap.put("customMade", this.customMade);
      ...
      pmap.put("contraband", this.contraband);
      ...
      pmap.put("largeCargoTransport", this.largeCargoTransport);
      ...
      pmap.put("sortCode", this.sortCode);
      ...
      pmap.put("boxLevelNo", this.boxLevelNo);
      pmap.put("boxLevelName", this.boxLevelName);
      pmap.put("boxLength", this.boxLength);
      pmap.put("boxWidth", this.boxWidth);
      pmap.put("boxHeight", this.boxHeight);
      pmap.put("boxNum", this.boxNum);
      pmap.put("boxGrossWeight", this.boxGrossWeight);
      pmap.put("billingSpecs", this.billingSpecs);
