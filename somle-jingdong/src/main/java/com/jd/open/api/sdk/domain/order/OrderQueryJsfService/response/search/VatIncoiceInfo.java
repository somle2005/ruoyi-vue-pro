...
public class VatIncoiceInfo implements Serializable {
   ...
   @JsonProperty("invoicePersonalName")
   public void setInvoicePersonalName(String invoicePersonalName) {
      this.invoicePersonalName = invoicePersonalName;
   }
   ...
   @JsonProperty("desen_userPhone")
   public void setDesenUserPhone(String desenUserPhone) {
      this.desenUserPhone = desenUserPhone;
   }

   @JsonProperty("desen_userPhone")
   public String getDesenUserPhone() {
      return this.desenUserPhone;
   }
}
