...
import com.jd.open.api.sdk.response.supplier.EdiPoGetResponse;
...
public class EdiPoGetRequest extends AbstractRequest implements JdRequest<EdiPoGetResponse> {
   ...
   public Class<EdiPoGetResponse> getResponseClass() {
      return EdiPoGetResponse.class;
   }
}
