...
import com.jd.open.api.sdk.response.shangjiashouhou.AscInvoiceViewResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscInvoiceViewRequest extends AbstractRequest implements JdRequest<AscInvoiceViewResponse> {
   private String buId;
   ...
   public Class<AscInvoiceViewResponse> getResponseClass() {
      return AscInvoiceViewResponse.class;
   }
}
