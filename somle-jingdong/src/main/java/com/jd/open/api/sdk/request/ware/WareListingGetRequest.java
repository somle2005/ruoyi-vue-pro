...
public class WareListingGetRequest extends AbstractRequest implements JdRequest<WareListingGetResponse> {
   private String cid;
   private String page;
   ...
   public Class<WareListingGetResponse> getResponseClass() {
      return WareListingGetResponse.class;
   }
