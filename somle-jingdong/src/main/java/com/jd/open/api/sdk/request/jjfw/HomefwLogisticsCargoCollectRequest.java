...
import com.jd.open.api.sdk.response.jjfw.HomefwLogisticsCargoCollectResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class HomefwLogisticsCargoCollectRequest extends AbstractRequest implements JdRequest<HomefwLogisticsCargoCollectResponse> {
   ...
   public String getApiMethod() {
      return "jingdong.homefw.logistics.cargoCollect";
   }
   ...
   public Class<HomefwLogisticsCargoCollectResponse> getResponseClass() {
      return HomefwLogisticsCargoCollectResponse.class;
   }
}
