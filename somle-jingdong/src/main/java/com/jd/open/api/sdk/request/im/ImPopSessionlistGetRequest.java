...
public class ImPopSessionlistGetRequest extends AbstractRequest implements JdRequest<ImPopSessionlistGetResponse> {
   ...
   public Class<ImPopSessionlistGetResponse> getResponseClass() {
      return ImPopSessionlistGetResponse.class;
   }
}
