...
import com.jd.open.api.sdk.response.shangjiashouhou.AscDoorPickWareListResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscDoorPickWareListRequest extends AbstractRequest implements JdRequest<AscDoorPickWareListResponse> {
   private String buId;
   ...
   public Class<AscDoorPickWareListResponse> getResponseClass() {
      return AscDoorPickWareListResponse.class;
   }
}
