...
public class PresaleOrderUpdateOrderGetPresaleOrderByPageRequest extends AbstractRequest implements JdRequest<PresaleOrderUpdateOrderGetPresaleOrderByPageResponse> {
   ...
   public String getAppJsonParams() throws IOException {
      ...
      pmap.put("beginIndex", this.beginIndex);
      pmap.put("endIndex", this.endIndex);
      return JsonUtil.toJson(pmap);
   }

   public Class<PresaleOrderUpdateOrderGetPresaleOrderByPageResponse> getResponseClass() {
      return PresaleOrderUpdateOrderGetPresaleOrderByPageResponse.class;
   }
}
