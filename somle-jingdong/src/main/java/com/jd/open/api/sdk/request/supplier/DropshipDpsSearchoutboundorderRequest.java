...
import com.jd.open.api.sdk.response.supplier.DropshipDpsSearchoutboundorderResponse;
...
public class DropshipDpsSearchoutboundorderRequest extends AbstractRequest implements JdRequest<DropshipDpsSearchoutboundorderResponse> {
   ...
   public Class<DropshipDpsSearchoutboundorderResponse> getResponseClass() {
      return DropshipDpsSearchoutboundorderResponse.class;
   }
}
