...
import com.jd.open.api.sdk.response.youE.UeOrderNewPartResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class UeOrderNewPartRequest extends AbstractRequest implements JdRequest<UeOrderNewPartResponse> {
   ...
   public Class<UeOrderNewPartResponse> getResponseClass() {
      return UeOrderNewPartResponse.class;
   }
}
