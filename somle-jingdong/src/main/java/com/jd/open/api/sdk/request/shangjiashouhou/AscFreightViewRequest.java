...
import com.jd.open.api.sdk.response.shangjiashouhou.AscFreightViewResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscFreightViewRequest extends AbstractRequest implements JdRequest<AscFreightViewResponse> {
   private String buId;
   ...
   public Class<AscFreightViewResponse> getResponseClass() {
      return AscFreightViewResponse.class;
   }
}
