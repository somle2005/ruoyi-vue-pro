...
import com.jd.open.api.sdk.response.ECLP.EclpMasterModifySupplierResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class EclpMasterModifySupplierRequest extends AbstractRequest implements JdRequest<EclpMasterModifySupplierResponse> {
   ...
   public String getAppJsonParams() throws IOException {
      ...
      pmap.put("eclpSupplierNo", this.eclpSupplierNo);
   ...
   public Class<EclpMasterModifySupplierResponse> getResponseClass() {
      return EclpMasterModifySupplierResponse.class;
   }
}
