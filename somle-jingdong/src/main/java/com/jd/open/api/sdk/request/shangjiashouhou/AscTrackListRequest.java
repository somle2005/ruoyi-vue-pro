...
import com.jd.open.api.sdk.response.shangjiashouhou.AscTrackListResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscTrackListRequest extends AbstractRequest implements JdRequest<AscTrackListResponse> {
   private String buId;
   ...
   public Class<AscTrackListResponse> getResponseClass() {
      return AscTrackListResponse.class;
   }
}
