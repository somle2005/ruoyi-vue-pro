...
import com.jd.open.api.sdk.response.shangjiashouhou.AscAuditSendResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscAuditSendRequest extends AbstractRequest implements JdRequest<AscAuditSendResponse> {
   private String buId;
   ...
   public Class<AscAuditSendResponse> getResponseClass() {
      return AscAuditSendResponse.class;
   }
}
