...
import com.jd.open.api.sdk.response.shangjiashouhou.AscViewOriginalOrderResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscViewOriginalOrderRequest extends AbstractRequest implements JdRequest<AscViewOriginalOrderResponse> {
   private String buId;
   ...
   public Class<AscViewOriginalOrderResponse> getResponseClass() {
      return AscViewOriginalOrderResponse.class;
   }
}
