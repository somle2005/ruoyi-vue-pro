...
public class RtsResult implements Serializable {
   ...
   public void setRtsBatchList(List<RtsBatch> rtsBatchList) {
      this.rtsBatchList = rtsBatchList;
   }
   ...
   @JsonProperty("tcOrderNo")
   public void setTcOrderNo(String tcOrderNo) {
      this.tcOrderNo = tcOrderNo;
   }
