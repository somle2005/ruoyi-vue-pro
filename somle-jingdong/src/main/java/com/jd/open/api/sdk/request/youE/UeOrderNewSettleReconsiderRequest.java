...
import com.jd.open.api.sdk.response.youE.UeOrderNewSettleReconsiderResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class UeOrderNewSettleReconsiderRequest extends AbstractRequest implements JdRequest<UeOrderNewSettleReconsiderResponse> {
   ...
   public Class<UeOrderNewSettleReconsiderResponse> getResponseClass() {
      return UeOrderNewSettleReconsiderResponse.class;
   }
}
