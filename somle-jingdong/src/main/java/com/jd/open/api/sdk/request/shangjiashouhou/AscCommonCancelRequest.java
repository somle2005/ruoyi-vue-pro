...
import com.jd.open.api.sdk.response.shangjiashouhou.AscCommonCancelResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscCommonCancelRequest extends AbstractRequest implements JdRequest<AscCommonCancelResponse> {
   private String buId;
   ...
   public Class<AscCommonCancelResponse> getResponseClass() {
      return AscCommonCancelResponse.class;
   }
}
