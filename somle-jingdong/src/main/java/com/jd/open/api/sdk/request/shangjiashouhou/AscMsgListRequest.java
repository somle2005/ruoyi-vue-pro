...
import com.jd.open.api.sdk.response.shangjiashouhou.AscMsgListResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscMsgListRequest extends AbstractRequest implements JdRequest<AscMsgListResponse> {
   private String buId;
   ...
   public Class<AscMsgListResponse> getResponseClass() {
      return AscMsgListResponse.class;
   }
}
