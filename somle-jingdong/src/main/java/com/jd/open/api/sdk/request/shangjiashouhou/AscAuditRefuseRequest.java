...
import com.jd.open.api.sdk.response.shangjiashouhou.AscAuditRefuseResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscAuditRefuseRequest extends AbstractRequest implements JdRequest<AscAuditRefuseResponse> {
   private String buId;
   ...
   public Class<AscAuditRefuseResponse> getResponseClass() {
      return AscAuditRefuseResponse.class;
   }
}
