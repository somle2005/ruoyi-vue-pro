...
public class ImPopChatlogGetRequest extends AbstractRequest implements JdRequest<ImPopChatlogGetResponse> {
   ...
   public String getAppJsonParams() throws IOException {
      ...
      pmap.put("customer", this.customer);
   ...
   public Class<ImPopChatlogGetResponse> getResponseClass() {
      return ImPopChatlogGetResponse.class;
   }
}
