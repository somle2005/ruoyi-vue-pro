...
public class AfsserviceReceivetaskGetRequest extends AbstractRequest implements JdRequest<AfsserviceReceivetaskGetResponse> {
   ...
   public Class<AfsserviceReceivetaskGetResponse> getResponseClass() {
      return AfsserviceReceivetaskGetResponse.class;
   }
}
