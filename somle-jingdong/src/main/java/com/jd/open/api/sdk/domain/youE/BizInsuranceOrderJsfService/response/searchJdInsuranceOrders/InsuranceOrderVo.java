package com.jd.open.api.sdk.domain.youE.BizInsuranceOrderJsfService.response.searchJdInsuranceOrders;
...
public class InsuranceOrderVo implements Serializable {
   ...
   public void setServiceSkuPromotionPrice(String serviceSkuPromotionPrice) {
      this.serviceSkuPromotionPrice = serviceSkuPromotionPrice;
   }
   ...
   public void setServiceSettlePrice(String serviceSettlePrice) {
   ...
   public void setMainPromotionPrice(String mainPromotionPrice) {
      this.mainPromotionPrice = mainPromotionPrice;
   }
