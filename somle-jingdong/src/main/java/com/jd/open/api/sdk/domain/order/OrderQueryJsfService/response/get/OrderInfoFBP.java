...
public class OrderInfoFBP implements Serializable {
   ...
   private UserInfoFBP consigneeInfo;
   private List<ItemInfoFBP> itemInfoList;
   ...
   private List<CouponDetailFBP> couponDetailList;
   ...
   public void setConsigneeInfo(UserInfoFBP consigneeInfo) {
      this.consigneeInfo = consigneeInfo;
   }

   @JsonProperty("consigneeInfo")
   public UserInfoFBP getConsigneeInfo() {
      return this.consigneeInfo;
   }

   @JsonProperty("itemInfoList")
   public void setItemInfoList(List<ItemInfoFBP> itemInfoList) {
      this.itemInfoList = itemInfoList;
   }

   @JsonProperty("itemInfoList")
   public List<ItemInfoFBP> getItemInfoList() {
   ...
   public void setCouponDetailList(List<CouponDetailFBP> couponDetailList) {
      this.couponDetailList = couponDetailList;
   }

   @JsonProperty("couponDetailList")
   public List<CouponDetailFBP> getCouponDetailList() {
