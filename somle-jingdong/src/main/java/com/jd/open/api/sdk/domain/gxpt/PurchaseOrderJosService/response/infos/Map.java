...
public class Map implements Serializable {
   ...
   public void setJdStoreId(Integer jdStoreId) {
   ...
   @JsonProperty("supplierVenderName")
   public void setSupplierVenderName(String supplierVenderName) {
      this.supplierVenderName = supplierVenderName;
   }

   @JsonProperty("supplierVenderName")
   public String getSupplierVenderName() {
      return this.supplierVenderName;
   }

   @JsonProperty("supplierShopId")
