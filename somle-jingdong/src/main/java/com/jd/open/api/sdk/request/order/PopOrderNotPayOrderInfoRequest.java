...
public class PopOrderNotPayOrderInfoRequest extends AbstractRequest implements JdRequest<PopOrderNotPayOrderInfoResponse> {
   ...
   public Class<PopOrderNotPayOrderInfoResponse> getResponseClass() {
      return PopOrderNotPayOrderInfoResponse.class;
   }
}
