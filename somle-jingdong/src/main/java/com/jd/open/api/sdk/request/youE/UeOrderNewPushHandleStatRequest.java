...
import com.jd.open.api.sdk.response.youE.UeOrderNewPushHandleStatResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class UeOrderNewPushHandleStatRequest extends AbstractRequest implements JdRequest<UeOrderNewPushHandleStatResponse> {
   ...
   public Class<UeOrderNewPushHandleStatResponse> getResponseClass() {
      return UeOrderNewPushHandleStatResponse.class;
   }
}
