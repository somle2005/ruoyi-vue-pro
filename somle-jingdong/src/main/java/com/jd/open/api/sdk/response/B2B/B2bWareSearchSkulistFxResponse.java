...
import com.jd.open.api.sdk.domain.B2B.BWareSearchService.response.fx.SdkPageResult;
import com.jd.open.api.sdk.response.AbstractResponse;

public class B2bWareSearchSkulistFxResponse extends AbstractResponse {
