...
import com.jd.open.api.sdk.response.HouseEI.LasImHfsInstallPushResponse;
...
public class LasImHfsInstallPushRequest extends AbstractRequest implements JdRequest<LasImHfsInstallPushResponse> {
   ...
   public void setInsDet(String insDet) {
      this.insDet = insDet;
   }
   ...
   public String getAppJsonParams() throws IOException {
      ...
      pmap.put("ins_det", this.insDet);
      return JsonUtil.toJson(pmap);
   }

   public Class<LasImHfsInstallPushResponse> getResponseClass() {
      return LasImHfsInstallPushResponse.class;
   }
}
