...
import com.jd.open.api.sdk.response.youE.UeOrderNewAppointSiteResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class UeOrderNewAppointSiteRequest extends AbstractRequest implements JdRequest<UeOrderNewAppointSiteResponse> {
   ...
   public void setSiteAcceptDate(String siteAcceptDate) {
      this.siteAcceptDate = siteAcceptDate;
   }

   public String getSiteAcceptDate() {
      return this.siteAcceptDate;
   }
   ...
   public String getAppJsonParams() throws IOException {
      ...
      pmap.put("siteAcceptDate", this.siteAcceptDate);
      pmap.put("unifiedCode", this.unifiedCode);
      pmap.put("personName", this.personName);
      pmap.put("personMobile", this.personMobile);
      pmap.put("personPib", this.personPib);
      pmap.put("accountName", this.accountName);
      pmap.put("bankCode", this.bankCode);
      pmap.put("bankName", this.bankName);
      pmap.put("dutyParagraph", this.dutyParagraph);
      pmap.put("bankAccount", this.bankAccount);
      return JsonUtil.toJson(pmap);
   }

   public Class<UeOrderNewAppointSiteResponse> getResponseClass() {
      return UeOrderNewAppointSiteResponse.class;
   }
}
