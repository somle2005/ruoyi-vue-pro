...
import com.jd.open.api.sdk.response.youE.Jd3csOrderQueryOrderEvaluateResponse;
...
public class Jd3csOrderQueryOrderEvaluateRequest extends AbstractRequest implements JdRequest<Jd3csOrderQueryOrderEvaluateResponse> {
   ...
   public Class<Jd3csOrderQueryOrderEvaluateResponse> getResponseClass() {
      return Jd3csOrderQueryOrderEvaluateResponse.class;
   }
}
