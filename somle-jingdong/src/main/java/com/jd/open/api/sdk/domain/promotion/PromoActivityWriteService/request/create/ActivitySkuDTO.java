...
public class ActivitySkuDTO implements Serializable {
   ...
   @JsonProperty("realVenderId")
   public void setRealVenderId(Long realVenderId) {
      this.realVenderId = realVenderId;
   }

   @JsonProperty("realVenderId")
   public Long getRealVenderId() {
      return this.realVenderId;
   }
