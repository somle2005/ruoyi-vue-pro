...
import com.jd.open.api.sdk.response.promotion.SellerPromotionV2CountResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class SellerPromotionV2CountRequest extends AbstractRequest implements JdRequest<SellerPromotionV2CountResponse> {
   private String ip;
   private String port;
   ...
   public Class<SellerPromotionV2CountResponse> getResponseClass() {
      return SellerPromotionV2CountResponse.class;
   }
}
