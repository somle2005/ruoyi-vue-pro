...
import com.jd.open.api.sdk.response.evaluation.PopPopCommentJsfServiceGetUserCommentVoucherResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class PopPopCommentJsfServiceGetUserCommentVoucherRequest extends AbstractRequest implements JdRequest<PopPopCommentJsfServiceGetUserCommentVoucherResponse> {
   ...
   public Class<PopPopCommentJsfServiceGetUserCommentVoucherResponse> getResponseClass() {
      return PopPopCommentJsfServiceGetUserCommentVoucherResponse.class;
   }
}
