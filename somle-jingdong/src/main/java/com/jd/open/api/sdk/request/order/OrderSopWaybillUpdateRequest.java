...
public class OrderSopWaybillUpdateRequest extends AbstractRequest implements JdRequest<OrderSopWaybillUpdateResponse> {
   ...
   public Class<OrderSopWaybillUpdateResponse> getResponseClass() {
      return OrderSopWaybillUpdateResponse.class;
   }
