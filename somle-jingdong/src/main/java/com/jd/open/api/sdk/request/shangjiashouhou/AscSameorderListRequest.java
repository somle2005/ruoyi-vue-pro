...
import com.jd.open.api.sdk.response.shangjiashouhou.AscSameorderListResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscSameorderListRequest extends AbstractRequest implements JdRequest<AscSameorderListResponse> {
   private String buId;
   ...
   public Class<AscSameorderListResponse> getResponseClass() {
      return AscSameorderListResponse.class;
   }
}
