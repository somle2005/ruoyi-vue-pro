...
public class UeOrderNewAppointEngineerRequest extends AbstractRequest implements JdRequest<UeOrderNewAppointEngineerResponse> {
   ...
   private String engAcceptDate;
   private Integer nucleicAcidResult;
   private String temperature;
   private String temperatureTime;
   private String isvaccinationTime;
   ...
   public void setEngAcceptDate(String engAcceptDate) {
      this.engAcceptDate = engAcceptDate;
   }

   public String getEngAcceptDate() {
      return this.engAcceptDate;
   }

   public void setNucleicAcidResult(Integer nucleicAcidResult) {
      this.nucleicAcidResult = nucleicAcidResult;
   }

   public Integer getNucleicAcidResult() {
   ...
   public void setIsvaccinationTime(String isvaccinationTime) {
      this.isvaccinationTime = isvaccinationTime;
   }

   public String getIsvaccinationTime() {
      return this.isvaccinationTime;
   }
   ...
   public String getAppJsonParams() throws IOException {
      ...
      pmap.put("engAcceptDate", this.engAcceptDate);
      pmap.put("nucleicAcidResult", this.nucleicAcidResult);
      pmap.put("temperature", this.temperature);
      pmap.put("temperatureTime", this.temperatureTime);
      pmap.put("isvaccinationTime", this.isvaccinationTime);
