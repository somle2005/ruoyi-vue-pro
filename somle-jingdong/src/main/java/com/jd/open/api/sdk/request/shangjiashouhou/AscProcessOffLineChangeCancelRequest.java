...
import com.jd.open.api.sdk.response.shangjiashouhou.AscProcessOffLineChangeCancelResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscProcessOffLineChangeCancelRequest extends AbstractRequest implements JdRequest<AscProcessOffLineChangeCancelResponse> {
   private String buId;
   ...
   public Class<AscProcessOffLineChangeCancelResponse> getResponseClass() {
      return AscProcessOffLineChangeCancelResponse.class;
   }
}
