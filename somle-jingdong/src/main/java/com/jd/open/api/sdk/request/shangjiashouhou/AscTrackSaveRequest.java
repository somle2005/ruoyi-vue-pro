...
import com.jd.open.api.sdk.response.shangjiashouhou.AscTrackSaveResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscTrackSaveRequest extends AbstractRequest implements JdRequest<AscTrackSaveResponse> {
   private String buId;
   ...
   public Class<AscTrackSaveResponse> getResponseClass() {
      return AscTrackSaveResponse.class;
   }
}
