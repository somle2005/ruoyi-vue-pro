...
import com.jd.open.api.sdk.response.shangjiashouhou.AscReceiveViewResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscReceiveViewRequest extends AbstractRequest implements JdRequest<AscReceiveViewResponse> {
   private String buId;
   ...
   public Class<AscReceiveViewResponse> getResponseClass() {
      return AscReceiveViewResponse.class;
   }
}
