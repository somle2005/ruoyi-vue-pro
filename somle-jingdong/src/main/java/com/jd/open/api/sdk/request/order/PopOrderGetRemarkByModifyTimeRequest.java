...
public class PopOrderGetRemarkByModifyTimeRequest extends AbstractRequest implements JdRequest<PopOrderGetRemarkByModifyTimeResponse> {
   ...
   public Class<PopOrderGetRemarkByModifyTimeResponse> getResponseClass() {
      return PopOrderGetRemarkByModifyTimeResponse.class;
   }
}
