...
import com.jd.open.api.sdk.response.Marketing.SellerPromotionAppendPromoUsersResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class SellerPromotionAppendPromoUsersRequest extends AbstractRequest implements JdRequest<SellerPromotionAppendPromoUsersResponse> {
   private String ip;
   private String port;
   ...
   public Class<SellerPromotionAppendPromoUsersResponse> getResponseClass() {
      return SellerPromotionAppendPromoUsersResponse.class;
   }
}
