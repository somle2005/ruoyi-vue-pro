...
public class HomefwTaskFinishRequest extends AbstractRequest implements JdRequest<HomefwTaskFinishResponse> {
   ...
   public Class<HomefwTaskFinishResponse> getResponseClass() {
      return HomefwTaskFinishResponse.class;
   }
}
