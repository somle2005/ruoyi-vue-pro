...
import com.jd.open.api.sdk.response.shangjiashouhou.AscViewServiceTelResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscViewServiceTelRequest extends AbstractRequest implements JdRequest<AscViewServiceTelResponse> {
   private String buId;
   ...
   public Class<AscViewServiceTelResponse> getResponseClass() {
      return AscViewServiceTelResponse.class;
   }
}
