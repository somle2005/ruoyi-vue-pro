...
import com.jd.open.api.sdk.response.aqyzzx.MfaInnerUserUnifiedAuthenticationResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class MfaInnerUserUnifiedAuthenticationRequest extends AbstractRequest implements JdRequest<MfaInnerUserUnifiedAuthenticationResponse> {
   ...
   public Class<MfaInnerUserUnifiedAuthenticationResponse> getResponseClass() {
      return MfaInnerUserUnifiedAuthenticationResponse.class;
   }
}
