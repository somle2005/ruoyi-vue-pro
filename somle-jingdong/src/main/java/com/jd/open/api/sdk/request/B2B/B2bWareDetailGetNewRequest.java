...
import com.jd.open.api.sdk.response.B2B.B2bWareDetailGetNewResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class B2bWareDetailGetNewRequest extends AbstractRequest implements JdRequest<B2bWareDetailGetNewResponse> {
   ...
   public String getApiMethod() {
      return "jingdong.b2b.ware.detail.getNew";
   }
   ...
   public Class<B2bWareDetailGetNewResponse> getResponseClass() {
      return B2bWareDetailGetNewResponse.class;
   }
}
