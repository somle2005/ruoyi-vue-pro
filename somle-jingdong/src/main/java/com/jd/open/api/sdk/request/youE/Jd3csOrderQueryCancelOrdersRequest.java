...
import com.jd.open.api.sdk.response.youE.Jd3csOrderQueryCancelOrdersResponse;
...
public class Jd3csOrderQueryCancelOrdersRequest extends AbstractRequest implements JdRequest<Jd3csOrderQueryCancelOrdersResponse> {
   ...
   public String getAppJsonParams() throws IOException {
      ...
      pmap.put("cancelStatus", this.cancelStatus);
   ...
   public Class<Jd3csOrderQueryCancelOrdersResponse> getResponseClass() {
      return Jd3csOrderQueryCancelOrdersResponse.class;
   }
}
