...
import com.jd.open.api.sdk.response.shangjiashouhou.AscAuditReissueResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscAuditReissueRequest extends AbstractRequest implements JdRequest<AscAuditReissueResponse> {
   private String buId;
   ...
   public Class<AscAuditReissueResponse> getResponseClass() {
      return AscAuditReissueResponse.class;
   }
}
