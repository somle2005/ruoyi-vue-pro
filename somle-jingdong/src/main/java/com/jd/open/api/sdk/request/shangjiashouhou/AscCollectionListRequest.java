...
import com.jd.open.api.sdk.response.shangjiashouhou.AscCollectionListResponse;
...
public class AscCollectionListRequest extends AbstractRequest implements JdRequest<AscCollectionListResponse> {
   private String buId;
   ...
   public String getAppJsonParams() throws IOException {
      ...
      pmap.put("balanceFlag", this.balanceFlag);
   ...
   public Class<AscCollectionListResponse> getResponseClass() {
      return AscCollectionListResponse.class;
   }
}
