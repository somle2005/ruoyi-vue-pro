...
import com.jd.open.api.sdk.domain.B2B.DirectPayJosService.response.query.ErpPageResult;
import com.jd.open.api.sdk.response.AbstractResponse;

public class GxptDirectPayQueryResponse extends AbstractResponse {
