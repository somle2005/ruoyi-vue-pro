...
public class LdopWaybillReceiveRequest extends AbstractRequest implements JdRequest<LdopWaybillReceiveResponse> {
   ...
   private String shopCodeAddedService;
   private String receiveOAID;
   private Integer receiveOAIDType;
   ...
   public void setShopCodeAddedService(String shopCodeAddedService) {
      this.shopCodeAddedService = shopCodeAddedService;
   }

   public String getShopCodeAddedService() {
   ...
   public void setReceiveOAIDType(Integer receiveOAIDType) {
      this.receiveOAIDType = receiveOAIDType;
   }

   public Integer getReceiveOAIDType() {
   ...
   public String getAppJsonParams() throws IOException {
      ...
      pmap.put("salesChannel", this.salesChannel);
      ...
      pmap.put("shopCodeAddedService", this.shopCodeAddedService);
      pmap.put("receiveOAID", this.receiveOAID);
      pmap.put("receiveOAIDType", this.receiveOAIDType);
      return JsonUtil.toJson(pmap);
   }

   public Class<LdopWaybillReceiveResponse> getResponseClass() {
      return LdopWaybillReceiveResponse.class;
   }
}
