...
import com.jd.open.api.sdk.domain.B2B.B2BStockQueryProvider.response.batchGetAreaStock.ResultBase;
import com.jd.open.api.sdk.response.AbstractResponse;

public class B2bStockBatchGetAreaStockResponse extends AbstractResponse {
