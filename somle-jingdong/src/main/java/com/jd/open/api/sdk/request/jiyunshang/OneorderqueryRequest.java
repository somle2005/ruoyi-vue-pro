...
import com.jd.open.api.sdk.response.jiyunshang.OneorderqueryResponse;
...
public class OneorderqueryRequest extends AbstractRequest implements JdRequest<OneorderqueryResponse> {
   ...
   public Class<OneorderqueryResponse> getResponseClass() {
      return OneorderqueryResponse.class;
   }
}
