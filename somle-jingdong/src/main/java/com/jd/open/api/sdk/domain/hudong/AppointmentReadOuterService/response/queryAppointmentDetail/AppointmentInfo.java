...
public class AppointmentInfo implements Serializable {
   ...
   private List<AppointmentSkuInfo> appointmentSkuInfos;
   ...
   private String encryptAutoAddCart;
   ...
   @JsonProperty("appointmentSkuInfos")
   public void setAppointmentSkuInfos(List<AppointmentSkuInfo> appointmentSkuInfos) {
      this.appointmentSkuInfos = appointmentSkuInfos;
   }

   @JsonProperty("appointmentSkuInfos")
   public List<AppointmentSkuInfo> getAppointmentSkuInfos() {
      return this.appointmentSkuInfos;
   }
   ...
   @JsonProperty("encrypt_autoAddCart")
   public void setEncryptAutoAddCart(String encryptAutoAddCart) {
      this.encryptAutoAddCart = encryptAutoAddCart;
   }

   @JsonProperty("encrypt_autoAddCart")
   public String getEncryptAutoAddCart() {
      return this.encryptAutoAddCart;
   }
}
