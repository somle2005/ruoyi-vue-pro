...
import com.jd.open.api.sdk.response.gxpt.PurchaseOrderSelectInfosResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class PurchaseOrderSelectInfosRequest extends AbstractRequest implements JdRequest<PurchaseOrderSelectInfosResponse> {
   ...
   public Class<PurchaseOrderSelectInfosResponse> getResponseClass() {
      return PurchaseOrderSelectInfosResponse.class;
   }
}
