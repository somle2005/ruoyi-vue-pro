...
import com.jd.open.api.sdk.response.order.UpdateEntityStoreResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class UpdateEntityStoreRequest extends AbstractRequest implements JdRequest<UpdateEntityStoreResponse> {
   ...
   public Class<UpdateEntityStoreResponse> getResponseClass() {
      return UpdateEntityStoreResponse.class;
   }
}
