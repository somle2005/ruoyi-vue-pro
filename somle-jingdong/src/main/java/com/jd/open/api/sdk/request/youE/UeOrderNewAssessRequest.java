...
import com.jd.open.api.sdk.response.youE.UeOrderNewAssessResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class UeOrderNewAssessRequest extends AbstractRequest implements JdRequest<UeOrderNewAssessResponse> {
   ...
   public Class<UeOrderNewAssessResponse> getResponseClass() {
      return UeOrderNewAssessResponse.class;
   }
}
