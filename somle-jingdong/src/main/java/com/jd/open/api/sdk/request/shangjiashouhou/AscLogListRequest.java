...
import com.jd.open.api.sdk.response.shangjiashouhou.AscLogListResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscLogListRequest extends AbstractRequest implements JdRequest<AscLogListResponse> {
   private String buId;
   ...
   public Class<AscLogListResponse> getResponseClass() {
      return AscLogListResponse.class;
   }
}
