...
import com.jd.open.api.sdk.response.youE.UeOrderNewGetSettleBillStatResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class UeOrderNewGetSettleBillStatRequest extends AbstractRequest implements JdRequest<UeOrderNewGetSettleBillStatResponse> {
   ...
   public Class<UeOrderNewGetSettleBillStatResponse> getResponseClass() {
      return UeOrderNewGetSettleBillStatResponse.class;
   }
}
