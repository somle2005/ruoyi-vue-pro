...
import com.jd.open.api.sdk.response.jinsuanpan.PopTaurusQueryRefundListByConditionResponse;
...
public class PopTaurusQueryRefundListByConditionRequest extends AbstractRequest implements JdRequest<PopTaurusQueryRefundListByConditionResponse> {
   ...
   public String getApiMethod() {
      return "jingdong.pop.taurus.queryRefundListByCondition";
   }
   ...
   public Class<PopTaurusQueryRefundListByConditionResponse> getResponseClass() {
      return PopTaurusQueryRefundListByConditionResponse.class;
   }
}
