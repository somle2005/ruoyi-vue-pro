...
import com.jd.open.api.sdk.response.shangjiashouhou.AscAddressJdAfsAddressResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class AscAddressJdAfsAddressRequest extends AbstractRequest implements JdRequest<AscAddressJdAfsAddressResponse> {
   private String buId;
   ...
   public Class<AscAddressJdAfsAddressResponse> getResponseClass() {
      return AscAddressJdAfsAddressResponse.class;
   }
}
