...
import com.jd.open.api.sdk.response.jialilue.CreateStoreJosResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class CreateStoreJosRequest extends AbstractRequest implements JdRequest<CreateStoreJosResponse> {
   ...
   public String getApiMethod() {
      return "jingdong.createStoreJos";
   }
   ...
   public Class<CreateStoreJosResponse> getResponseClass() {
      return CreateStoreJosResponse.class;
   }
}
