...
public class ImageWriteUpdateRequest extends AbstractRequest implements JdRequest<ImageWriteUpdateResponse> {
   private Long wareId;
   ...
   public String getAppJsonParams() throws IOException {
      ...
      pmap.put("imgZoneId", this.imgZoneId);
      pmap.put("isGgt", this.isGgt);
      return JsonUtil.toJson(pmap);
   }

   public Class<ImageWriteUpdateResponse> getResponseClass() {
      return ImageWriteUpdateResponse.class;
   }
}
