...
import com.jd.open.api.sdk.response.ware.WareSpuUniqueCodeListSearchResponse;
import java.io.IOException;
import java.util.Map;
import java.util.TreeMap;

public class WareSpuUniqueCodeListSearchRequest extends AbstractRequest implements JdRequest<WareSpuUniqueCodeListSearchResponse> {
   ...
   public Class<WareSpuUniqueCodeListSearchResponse> getResponseClass() {
      return WareSpuUniqueCodeListSearchResponse.class;
   }
}
