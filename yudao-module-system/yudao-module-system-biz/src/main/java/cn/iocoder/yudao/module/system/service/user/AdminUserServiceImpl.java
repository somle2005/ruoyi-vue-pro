...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    public PageResult<UserRespVO> getUserPage(UserPageReqVO reqVO) {
        PageResult<UserRespVO> pageResult = userMapper.selectJoinPage(reqVO, getDeptCondition(reqVO.getDeptId()));
        ...
        return new PageResult<>(CollectionUtils.convertList(pageResult.getList(),
                user -> user.setDeptName(deptMap.get(user.getDeptId()).getName())),
                pageResult.getTotal());
    }
