...
@Mapper
public interface OmsShopMapper extends BaseMapper<OmsShopDO> {
    ...
    default MPJLambdaWrapperX<OmsShopDO> bindQueryWrapper(OmsShopDO reqVO) {
        return (MPJLambdaWrapperX<OmsShopDO>) new MPJLambdaWrapperX<OmsShopDO>()
            ...
            .eqIfPresent(OmsShopDO::getCountryCode, reqVO.getCountryCode())  // 国家编码
            .eqIfPresent(OmsShopDO::getDomainName, reqVO.getDomainName())  // 域名
            .eqIfPresent(OmsShopDO::getPlatformShopUid, reqVO.getPlatformShopUid())  // 平台店铺UID
