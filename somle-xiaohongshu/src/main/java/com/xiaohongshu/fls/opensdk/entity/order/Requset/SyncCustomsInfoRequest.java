...
public class SyncCustomsInfoRequest extends BaseRequest {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof SyncCustomsInfoRequest)) {
         return false;
      } else {
         SyncCustomsInfoRequest other = (SyncCustomsInfoRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof SyncCustomsInfoRequest;
   }
   ...
   public String toString() {
      return "SyncCustomsInfoRequest(barcode=" + this.getBarcode() + ", customsName=" + this.getCustomsName() + ", hsCode=" + this.getHsCode() + ", generalTaxRate=" + this.getGeneralTaxRate() + ", quantity1=" + this.getQuantity1() + ", quantity2=" + this.getQuantity2() + ")";
   }
}
