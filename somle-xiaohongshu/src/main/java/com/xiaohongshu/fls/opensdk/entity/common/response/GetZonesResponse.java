...
public class GetZonesResponse {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof GetZonesResponse)) {
         return false;
      } else {
         GetZonesResponse other = (GetZonesResponse)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof GetZonesResponse;
   }
   ...
   public String toString() {
      return "GetZonesResponse(code=" + this.getCode() + ", name=" + this.getName() + ", upper=" + this.getUpper() + ", filterNonContinental=" + this.getFilterNonContinental() + ")";
   }
   ...
   public static class ZoneInfo {
      ...
      public String toString() {
         return "GetZonesResponse.ZoneInfo(name=" + this.getName() + ", shortName=" + this.getShortName() + ", code=" + this.getCode() + ", upper=" + this.getUpper() + ", initialPinyin=" + this.getInitialPinyin() + ", pinyin=" + this.getPinyin() + ", isActive=" + this.getIsActive() + ")";
      }
   }
}
