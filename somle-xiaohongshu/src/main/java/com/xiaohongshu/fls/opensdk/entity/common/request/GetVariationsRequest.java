...
public class GetVariationsRequest extends BaseRequest {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof GetVariationsRequest)) {
         return false;
      } else {
         GetVariationsRequest other = (GetVariationsRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof GetVariationsRequest;
   }
   ...
   public String toString() {
      return "GetVariationsRequest(categoryId=" + this.getCategoryId() + ")";
   }
}
