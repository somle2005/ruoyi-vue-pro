...
public class SkuDetail {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof SkuDetail)) {
         return false;
      } else {
         SkuDetail other = (SkuDetail)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof SkuDetail;
   }
   ...
   public static class VariantV3 {
      ...
      public String toString() {
         return "SkuDetail.VariantV3(id=" + this.getId() + ", name=" + this.getName() + ", value=" + this.getValue() + ", valueId=" + this.getValueId() + ")";
      }
   }
   ...
   public static class DeliveryTimeV3 {
      ...
      public String toString() {
         return "SkuDetail.DeliveryTimeV3(time=" + this.getTime() + ", type=" + this.getType() + ")";
      }
   }
   ...
   public static class UnionItemResultV3 {
      ...
      public String toString() {
         return "SkuDetail.UnionItemResultV3(id=" + this.getId() + ", name=" + this.getName() + ", scSkuCode=" + this.getScSkuCode() + ", barcode=" + this.getBarcode() + ", ipq=" + this.getIpq() + ", erpCode=" + this.getErpCode() + ")";
      }
   }
}
