...
public class IncSkuStockRequest extends BaseRequest {
   public String skuId;
   public Integer qty;
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof IncSkuStockRequest)) {
         return false;
      } else {
         IncSkuStockRequest other = (IncSkuStockRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof IncSkuStockRequest;
   }
   ...
   public String toString() {
      return "IncSkuStockRequest(skuId=" + this.getSkuId() + ", qty=" + this.getQty() + ")";
   }
}
