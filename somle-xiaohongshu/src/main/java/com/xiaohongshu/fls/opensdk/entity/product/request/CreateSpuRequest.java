...
public class CreateSpuRequest extends BaseRequest {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof CreateSpuRequest)) {
         return false;
      } else {
         CreateSpuRequest other = (CreateSpuRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof CreateSpuRequest;
   }
   ...
   public static class SpuAttribute {
      ...
      public String toString() {
         return "CreateSpuRequest.SpuAttribute(propertyId=" + this.getPropertyId() + ", name=" + this.getName() + ", value=" + this.getValue() + ", valueId=" + this.getValueId() + ", valueList=" + this.getValueList() + ")";
      }
   }
   ...
   public static class AttributeValue {
      ...
      public String toString() {
         return "CreateSpuRequest.AttributeValue(valueId=" + this.getValueId() + ", value=" + this.getValue() + ")";
      }
   }
   ...
   public static class Faq {
      ...
      public String toString() {
         return "CreateSpuRequest.Faq(question=" + this.getQuestion() + ", answer=" + this.getAnswer() + ")";
      }
   }
}
