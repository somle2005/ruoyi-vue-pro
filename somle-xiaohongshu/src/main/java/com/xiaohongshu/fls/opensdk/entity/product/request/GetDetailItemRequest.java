...
public class GetDetailItemRequest extends BaseRequest {
   private String id;
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof GetDetailItemRequest)) {
         return false;
      } else {
         GetDetailItemRequest other = (GetDetailItemRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof GetDetailItemRequest;
   }
