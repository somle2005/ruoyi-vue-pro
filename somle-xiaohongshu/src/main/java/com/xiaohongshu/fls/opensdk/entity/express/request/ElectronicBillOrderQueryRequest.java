...
public class ElectronicBillOrderQueryRequest extends BaseRequest {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof ElectronicBillOrderQueryRequest)) {
         return false;
      } else {
         ElectronicBillOrderQueryRequest other = (ElectronicBillOrderQueryRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof ElectronicBillOrderQueryRequest;
   }
   ...
   public String toString() {
      return "ElectronicBillOrderQueryRequest(billVersion=" + this.getBillVersion() + ", cpCode=" + this.getCpCode() + ", waybillCode=" + this.getWaybillCode() + ")";
   }
}
