...
public class SearchItemListRequest extends BaseRequest {
   ...
   public void setSearchParam(ItemSearchParam searchParam) {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof SearchItemListRequest)) {
         return false;
      } else {
         SearchItemListRequest other = (SearchItemListRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof SearchItemListRequest;
   }
   ...
   public String toString() {
      return "SearchItemListRequest(pageNo=" + this.getPageNo() + ", pageSize=" + this.getPageSize() + ", searchParam=" + this.getSearchParam() + ")";
   }
   ...
   public static class ItemSearchParam {
      ...
      public boolean equals(Object o) {
         if (o == this) {
            return true;
         } else if (!(o instanceof ItemSearchParam)) {
            return false;
         } else {
            ItemSearchParam other = (ItemSearchParam)o;
            if (!other.canEqual(this)) {
               return false;
      ...
      protected boolean canEqual(Object other) {
         return other instanceof ItemSearchParam;
      }
      ...
      public String toString() {
         return "SearchItemListRequest.ItemSearchParam(keyword=" + this.getKeyword() + ", topCategoryIds=" + this.getTopCategoryIds() + ", lvl2CategoryIds=" + this.getLvl2CategoryIds() + ", lvl3CategoryIds=" + this.getLvl3CategoryIds() + ", lvl4CategoryIds=" + this.getLvl4CategoryIds() + ", buyable=" + this.getBuyable() + ", keywords=" + this.getKeywords() + ", logisticsPlanIds=" + this.getLogisticsPlanIds() + ", createTimeFrom=" + this.getCreateTimeFrom() + ", createTimeTo=" + this.getCreateTimeTo() + ", lastId=" + this.getLastId() + ")";
      }
   }
}
