...
public class GetPackageDetailRequest extends BaseRequest {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof GetPackageDetailRequest)) {
         return false;
      } else {
         GetPackageDetailRequest other = (GetPackageDetailRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof GetPackageDetailRequest;
   }
   ...
   public String toString() {
      return "GetPackageDetailRequest(packageId=" + this.getPackageId() + ")";
   }
}
