...
public class CreateItemRequest extends BaseRequest {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof CreateItemRequest)) {
         return false;
      } else {
   ...
   public String toString() {
      return "CreateItemRequest(spuId=" + this.getSpuId() + ", ipq=" + this.getIpq() + ", originalPrice=" + this.getOriginalPrice() + ", price=" + this.getPrice() + ", stock=" + this.getStock() + ", logisticsPlanId=" + this.getLogisticsPlanId() + ", whcode=" + this.getWhcode() + ", priceType=" + this.getPriceType() + ", erpCode=" + this.getErpCode() + ", variants=" + this.getVariants() + ", deliveryTime=" + this.getDeliveryTime() + ", specImageUrl=" + this.getSpecImageUrl() + ", barcode=" + this.getBarcode() + ", originItemId=" + this.getOriginItemId() + ", boutiqueMode=" + this.getBoutiqueMode() + ", freeReturn=" + this.getFreeReturn() + ")";
   }
   ...
   public static class VariantV3 {
      ...
      public String toString() {
         return "CreateItemRequest.VariantV3(id=" + this.getId() + ", name=" + this.getName() + ", value=" + this.getValue() + ", valueId=" + this.getValueId() + ")";
      }
   }
   ...
   public static class DeliveryTimeV3 {
      ...
      public String toString() {
         return "CreateItemRequest.DeliveryTimeV3(time=" + this.getTime() + ", type=" + this.getType() + ")";
      }
   }
}
