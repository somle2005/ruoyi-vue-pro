...
public class UpdateWarehouseRequest extends BaseRequest {
   ...
   public boolean equals(Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof UpdateWarehouseRequest)) {
         return false;
      } else {
         UpdateWarehouseRequest other = (UpdateWarehouseRequest)o;
   ...
   protected boolean canEqual(Object other) {
      return other instanceof UpdateWarehouseRequest;
   }
   ...
   public String toString() {
      return "UpdateWarehouseRequest(code=" + this.getCode() + ", name=" + this.getName() + ", zoneCode=" + this.getZoneCode() + ", address=" + this.getAddress() + ", contactName=" + this.getContactName() + ", contactTel=" + this.getContactTel() + ")";
   }
}
