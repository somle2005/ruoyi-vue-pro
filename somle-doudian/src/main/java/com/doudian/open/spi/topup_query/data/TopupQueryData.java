package com.doudian.open.spi.topup_query.data;
...
public class TopupQueryData {
	...
	@OpField(desc = "订单状态，可选范围： SUCCESS 订单充值成功 FAILED 订单充值失败 IN_PROCESS 订单充值中 如果返回状态非以上状态则将进行接口重试", example = "SUCCESS")
	private String sellerOrderStatus;

	@SerializedName("err_code")
	@OpField(desc = "错误码，当seller_order_status为FAILED时，需要填写充值失败的原因", example = "2001")
