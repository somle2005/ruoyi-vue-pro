...
public class Address {
	...
	@OpField(desc = "地址更新时间;", example = "2024-09-25 16:38:47")
	...
	@OpField(desc = "售后备注", example = "拒绝到付")
	...
	@OpField(desc = "是否是默认发货地址;0-不是，1-是", example = "1")
	private Long isSendDefault;

	@SerializedName("create_time")
	@OpField(desc = "地址创建时间;", example = "2024-09-25 16:33:15")
