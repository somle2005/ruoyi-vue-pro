...
public class SkuOrderListItem {
	...
	@OpField(desc = "商品单上关联的政府补贴信息；比如一品多地等", example = "")
	private GovSubsidyDetail govSubsidyDetail;

	@SerializedName("serial_no_info")
	@OpField(desc = "商品上关联的SN/69/IMEI码信息", example = "")
	...
	@OpField(desc = "周期购信息", example = "")
	private SkuPeriodPurchaseInfo skuPeriodPurchaseInfo;

	@SerializedName("sp_product_id")
	@OpField(desc = "服务商品编码，如维修服务单上设置的服务商品编码", example = "389038453")
	private String spProductId;

	@SerializedName("relation_sku_order_ids")
	@OpField(desc = "与当前商品单有关联的商品单，如维修主商品单关联的维修单商品单号", example = "[6982304832423]")
	...
	@OpField(desc = "商品单的额外信息；barcodes: [6970848860361],--商家设置商品单对应的69码", example = "{barcodes: [6970848860361]}")
	private Map<String,String> extraInfo;

	@SerializedName("prescription_info_list")
	@OpField(desc = "处方单列表", example = "")
	private List<PrescriptionInfoListItem> prescriptionInfoList;

	@SerializedName("voucher_deduction_amount")
	@OpField(desc = "提货券商品抵扣金额 单位：分", example = "200")
	private Long voucherDeductionAmount;

	@SerializedName("home_installation_service_info")
	@OpField(desc = "上门安装服务信息", example = "")
	private HomeInstallationServiceInfo homeInstallationServiceInfo;

	@SerializedName("free_interest")
	@OpField(desc = "商品单抖音月付免息信息", example = "")
	...
	@OpField(desc = "商品原价（单位：分）", example = "100")
	private Long goodsPrice;

	@SerializedName("sku_car_model_desc")
	@OpField(desc = "车型", example = "车型")
	private String skuCarModelDesc;

	@SerializedName("quality_inspection_status")
	@OpField(desc = "质检状态;0-无需质检;1-可质检;2-必须质检", example = "质检状态")
	...
	@OpField(desc = "店铺父订单号，抖店平台生成，平台下唯一；", example = "4781320682406083640")
	...
	@OpField(desc = "交易类型：0-普通；1-拼团；2-定金预售；3-订金找货；4-拍卖；5-0元单；6-回收；7-寄卖；10-寄样；11-0元抽奖(超级福袋)；12-达人买样；13-普通定制；16-大众竞拍；18-小时达；102-定金预售的赠品单；103-收款；", example = "1")
	...
	@OpField(desc = "支付时间，时间戳，秒", example = "1617355413")
	...
	@OpField(desc = "订单完成时间，时间戳，秒", example = "1617355413")
	...
	@OpField(desc = "订单更新时间，时间戳，秒", example = "1617355413")
	...
	@OpField(desc = "下单场景描述", example = "app")
	...
	@OpField(desc = "直播主播id（达人）;仅直播间和橱窗产生的订单会有值返回;", example = "341234")
	private Long authorId;

	@SerializedName("author_name")
	@OpField(desc = "直播主播名称;仅直播间和橱窗产生的订单会有值返回", example = "XXXX")
	private String authorName;

	@SerializedName("theme_type")
	@OpField(desc = "【下单来源】 0-其他 1-直播间（废弃）", example = "1")
	private String themeType;

	@SerializedName("theme_type_desc")
	@OpField(desc = "下单来源描述（废弃）", example = "直播间")
	...
	@OpField(desc = "直播房间ID，字符串类型", example = "1473196049974326153")
	private Long roomId;

	@SerializedName("content_id")
	@OpField(desc = "内容id。（该字段无实际意义，已废弃）", example = "43545454556")
	private String contentId;

	@SerializedName("video_id")
	@OpField(desc = "视频id，有值则代表订单来自短视频", example = "43545454556")
	private String videoId;

	@SerializedName("origin_id")
	@OpField(desc = "已废弃，流量来源id", example = "43545454556")
	private String originId;

	@SerializedName("cid")
	@OpField(desc = "已废弃，广告id", example = "43545454556")
	private Long cid;
	...
	@OpField(desc = "C端流量来源业务类型描述", example = "小店自卖")
	...
	@SerializedName("code")
	@OpField(desc = "商家后台商品编码", example = "ahgldjj")
	private String code;
	...
	@OpField(desc = "优惠信息", example = "")
	private PromotionDetail_4_4 promotionDetail;

	@SerializedName("campaign_info")
	@OpField(desc = "活动信息，其中活动金额会体现到商品价格中（比如商品原价是100元，参加活动优惠20元，那商品现价就为80元）", example = "")
	...
	@OpField(desc = "是否评价 :1-已评价，0-未评价，2 -追评", example = "1")
	private Long isComment;

	@SerializedName("product_name")
	@OpField(desc = "商品名称", example = "XX鞋子")
	...
	@OpField(desc = "核销信息", example = "")
	private List<WriteoffInfoItem> writeoffInfo;

	@SerializedName("relation_order")
	@OpField(desc = "关联订单", example = "")
	private RelationOrder relationOrder;
	...
	@OpField(desc = "是否需要上传序列号，用于判断发货时是否需要上传商品序列号（IMEI码或SN码），true 表示是3C数码商品，需要上传序列号", example = "true")
	...
	@OpField(desc = "废弃，使用master_sku_order_id_list；绑定的主品sku单单号 如果given_product_type=FREE 则master_sku_order_id为主品sku单单号", example = "1")
	...
	@OpField(desc = "当order_type=2，order_type_desc为虚拟订单时该参数会返回信息", example = "")
	...
	@OpField(desc = "是否是补贴品订单", example = "false")
	...
	@OpField(desc = "收件人电话（脱敏后），电商脱敏格式为1********35，即时零售脱敏格式为*******1035(后四位明文)", example = "1********35")
	...
	@OpField(desc = "绑定的主品sku单单号 如果given_product_type=FREE 则master_sku_order_id_list为主品sku单单号", example = "[4781320682406083640]")
	...
	public void setPrescriptionInfoList(List<PrescriptionInfoListItem> prescriptionInfoList){
		this.prescriptionInfoList = prescriptionInfoList;
	}

	
	public List<PrescriptionInfoListItem> getPrescriptionInfoList(){
	...
	public void setHomeInstallationServiceInfo(HomeInstallationServiceInfo homeInstallationServiceInfo){
		this.homeInstallationServiceInfo = homeInstallationServiceInfo;
	}

	
	public HomeInstallationServiceInfo getHomeInstallationServiceInfo(){
		return this.homeInstallationServiceInfo;
	}
	...
	public void setSkuCarModelDesc(String skuCarModelDesc){
		this.skuCarModelDesc = skuCarModelDesc;
	}

	
	public String getSkuCarModelDesc(){
		return this.skuCarModelDesc;
	}
	...
	public void setPromotionDetail(PromotionDetail_4_4 promotionDetail){
		this.promotionDetail = promotionDetail;
	}

	
	public PromotionDetail_4_4 getPromotionDetail(){
		return this.promotionDetail;
	}

	
	public void setCampaignInfo(List<CampaignInfoItem> campaignInfo){
	...
	public void setWriteoffInfo(List<WriteoffInfoItem> writeoffInfo){
		this.writeoffInfo = writeoffInfo;
	}

	
	public List<WriteoffInfoItem> getWriteoffInfo(){
		return this.writeoffInfo;
	}

	
	public void setRelationOrder(RelationOrder relationOrder){
		this.relationOrder = relationOrder;
	}

	
	public RelationOrder getRelationOrder(){
