...
public class Addr {
	...
	@OpField(required = true , desc = "一级地址", example= "一级地址")
	private Long addrId1;

	@SerializedName("addr_id2")
	@OpField(required = false , desc = "二级地址", example= "二级地址")
	private Long addrId2;

	@SerializedName("addr_id3")
	@OpField(required = false , desc = "三级地址", example= "三级地址")
	private Long addrId3;

	@SerializedName("addr_id4")
	@OpField(required = false , desc = "四级地址", example= "四级地址")
