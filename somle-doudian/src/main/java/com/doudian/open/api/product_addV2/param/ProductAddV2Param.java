...
public class ProductAddV2Param {


	@SerializedName("outer_product_id")
	@OpField(required = false , desc = "推荐使用，外部商家编码，支持字符串。超市小时达场景不推荐使用。out_product_id 、outer_product_id  都传了的话，要求相等。", example= "232334")
	private String outerProductId;

	@SerializedName("product_type")
	@OpField(required = true , desc = "0-普通，3-虚拟，6玉石闪购，7云闪购", example= "0")
	private Long productType;

	@SerializedName("category_leaf_id")
	@OpField(required = true , desc = "叶子类目ID通过/shop/getShopCategory接口获取", example= "20000")
	private Long categoryLeafId;

	@SerializedName("name")
	@OpField(required = true , desc = "商品名称，至少8个字符（4个汉字），最多60个字符(30个汉字)，不能含emoj表情", example= "xxx补水液")
	private String name;
	...
	@SerializedName("pic")
	@OpField(required = true , desc = "商品轮播图，多张图片用 | 分开，第一张图为主图，最多5张，至少600x600，大小不超过5M。", example= "img_url1|img_url2|img_url3")
	private String pic;

	@SerializedName("description")
	@OpField(required = true , desc = "商品描述，目前只支持图片。多张图片用 | 分开。不能用其他网站的文本粘贴，这样会出现css样式不兼容。总图片数量不得超过50张。", example= "img_url1|img_url2|img_url3")
	...
	@OpField(required = true , desc = "1 减库存类型：1-拍下减库存 2-付款减库存", example= "1")
	...
	@OpField(required = true , desc = "运费模板id，传0表示包邮，通过/freightTemplate/list接口获取", example= "123")
	...
	@OpField(required = true , desc = "客服电话号码", example= "40012345")
	...
	@OpField(required = false , desc = "外部product_id。超市小时达场景不推荐使用。out_product_id 、outer_product_id  都传了的话，要求相等。", example= "123")
	private Long outProductId;

	@SerializedName("quality_list")
	@OpField(required = false , desc = "资质，可通过/product/qualificationConfig获取", example= "")
	...
	@OpField(required = false , desc = "extra", example= "略")
	private String extra;

	@SerializedName("src")
	@OpField(required = false , desc = "src", example= "略")
	private String src;

	@SerializedName("standard_brand_id")
	@OpField(required = false , desc = "品牌id，通过/brand/list获取，无品牌id则传596120136", example= "111")
	...
	@OpField(required = false , desc = "汽车vin码", example= "BA111111111111111")
	private String carVinCode;

	@SerializedName("presell_config_level")
	@OpField(required = false , desc = "0：全款预售，1：sku预售，2：现货+预售 ，3：新预售", example= "3")
	private Long presellConfigLevel;

	@SerializedName("need_recharge_mode")
	@OpField(required = false , desc = "充值模式", example= "true")
	private Boolean needRechargeMode;

	@SerializedName("account_template_id")
	@OpField(required = false , desc = "账号模板id", example= "122112")
	...
	@OpField(required = false , desc = "白底图url(仅素材中心url有效)，白底图比例要求1:1", example= "http://aaaa")
	...
	@OpField(required = false , desc = "主图视频ID，可以先通过https://op.jinritemai.com/docs/api-docs/69/1617接口上传视频，获取审核通过的视频素材ID进行传入 任务需要验证", example= "vaaaa")
	...
	@OpField(required = false , desc = "门店ID", example= "12345")
	private Long storeId;

	@SerializedName("main_product_id")
	@OpField(required = false , desc = "主商品ID", example= "3121213121212")
	...
	@OpField(required = false , desc = "参考价，单位分，需大于商品价格并小于商品价格的10倍", example= "12300")
	private Long referencePrice;

	@SerializedName("reference_price_certificate")
	@OpField(required = false , desc = "参考价凭证信息", example= "")
	...
	@OpField(required = false , desc = "商品价格规则信息", example= "")
	...
	@OpField(required = false , desc = "是否是自动充值商品", example= "false")
	private Boolean isAutoCharge;

	@SerializedName("short_product_name")
	@OpField(required = false , desc = "导购短标题，短标题可用于物流打单及商品搜索场景，若未填写，则系统将智能生成最优短标题在商详购买页面展示，说明详见：https://school.jinritemai.com/doudian/web/article/aHUW2MCvHqF3?from=shop_article", example= "新品牛肉干")
	...
	@OpField(required = false , desc = "规格详细信息，代替specs和spec_name", example= "")
	private SpecInfo specInfo;

	@SerializedName("spec_prices_v2")
	@OpField(required = false , desc = "新sku参数，代替spec_prices", example= "")
	...
	@OpField(required = false , desc = "商品价格是否含税，跨境必需填1。  1：商品价格含税 2：商品价格不含税", example= "1")
	private String priceHasTax;

	@SerializedName("biz_kind")
	@OpField(required = false , desc = "商品是否跨境、教育等（跨境/海南商品填写2））", example= "2")
	private Long bizKind;

	@SerializedName("custom_property")
	@OpField(required = false , desc = "商品定制属性填写，（即时零售，外卖业务填写）", example= "")
	private CustomProperty customProperty;

	@SerializedName("is_evaluate_opened")
	@OpField(required = false , desc = "测评短视频开关", example= "false")
	private Boolean isEvaluateOpened;

	@SerializedName("default_process_time")
	@OpField(required = false , desc = "商品默认处理时长", example= "")
	private DefaultProcessTime defaultProcessTime;

	@SerializedName("company_id")
	@OpField(required = false , desc = "管理单元ID", example= "12345")
	private Long companyId;

	@SerializedName("is_second_hand_digital")
	@OpField(required = false , desc = "是否二手数码(成色机)", example= "false")
	private Boolean isSecondHandDigital;

	@SerializedName("recommend_ids")
	@OpField(required = false , desc = "预测记录id，类目预测记录key=category_recommend_id", example= "{category_recommend_id:qwert12345}")
