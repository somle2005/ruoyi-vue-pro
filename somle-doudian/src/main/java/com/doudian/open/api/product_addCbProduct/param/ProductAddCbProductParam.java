...
public class ProductAddCbProductParam {
	...
	@SerializedName("name")
	@OpField(required = true , desc = "商品名称，最多60个字符(30个汉字)，不能含emoj表情", example= "xx补水液")
	private String name;
	...
	@SerializedName("pic")
	@OpField(required = true , desc = "商品轮播图，多张图片用 | 分开，第一张图为主图，最多5张，至少600x600，大小不超过1M 注：pic、description、spec_pic这三个字段里的传入的图片数量总和，不得超过50张。", example= "img_url1|img_url2|img_url3")
	private String pic;

	@SerializedName("description")
	@OpField(required = true , desc = "商品描述，目前只支持图片。多张图片用 | 分开。不能用其他网站的文本粘贴，这样会出现css样式不兼容 注：pic、description、spec_pic这三个字段里的传入的图片数量总和，不得超过50张。", example= "img_url1|img_url2|img_url3")
	private String description;

	@SerializedName("pay_type")
	@OpField(required = true , desc = "支付方式，0货到付款 1在线支付，2，货到付款+在线支付", example= "1")
	...
	@OpField(required = false , desc = "delivery_delay_day： 承诺发货时间，单位是天,不传则默认为2天。现货发货(presell_type=0)和阶梯发货模式(presell_type=2)时必填，支持传入9999 、1、 2 （分别表示当日发、次日发、48小时发），具体支持传入的参数范围/product/getProductUpdateRule", example= "3")
	...
	@OpField(required = false , desc = "全款预售模式时的发货时间/阶梯模式下阶梯发货时间，具体支持传入的参数范围/product/getProductUpdateRule", example= "3")
	...
	@OpField(required = true , desc = "【该字段将在2023年4月30日下线，请开发使用最新的after_sale_service字段传值；】是否支持7天无理由，0不支持，1支持，2支持（拆封后不支持）", example= "该字段将在2023年4月30日下线，请开发使用最新的after_sale_service字段传值；")
	...
	@OpField(required = false , desc = "外部product_id", example= "123")
	...
	@OpField(required = false , desc = "通过/product/getCatePropertyV2获取 格式：{property_id:[{value:value,name:property_name,diy_type:0}]} name的类型是string，value和diy_type的类型是number", example= "{1542:[{value:23964,name:是,diy_type:0}],1633:[{value:38417,name:锁水,diy_type:0}],1687:[{value:111004867,name:12/12,diy_type:0}],1880:[{value:4171,name:韩国,diy_type:0}],2685:[{value:0,name:1,diy_type:0}],2976:[{value:0,name:1,diy_type:0}],2988:[{value:0,name:2,diy_type:0}],3299:[{value:0,name:2,diy_type:0}]}")
	...
	@OpField(required = false , desc = "售卖方式;0:全渠道售卖,1:仅指定直播间售卖", example= "0")
	...
	@OpField(required = false , desc = "{customs_clear_type:4,origin_region_id: 3573511,source_region_id: 3573511,brand_region_id: 174982,net_weight_qty:13.4,tax_payer:0}", example= "跨境物流信息")
	private String logisticsInfo;

	@SerializedName("price_has_tax")
	@OpField(required = false , desc = "商品价格是否含税", example= "1")
	...
	@OpField(required = false , desc = "售价，单位分，含税价", example= "11000")
	private Long discountPrice;

	@SerializedName("market_price")
	@OpField(required = false , desc = "划线价，单位分，含税价(在spec_prices设置)", example= "13345")
	private Long marketPrice;

	@SerializedName("size_info_template_id")
	@OpField(required = false , desc = "尺码表", example= "1")
