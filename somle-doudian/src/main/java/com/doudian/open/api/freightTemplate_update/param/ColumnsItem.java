...
public class ColumnsItem {
	...
	@OpField(required = false , desc = "0:阶梯计价；1:固定运费；2:卖家包邮", example= "1")
	...
	@OpField(required = false , desc = "2:次日达；3:全国送；（仅在多种履约模式下生效该字段）；100：中转履约模式", example= "2")
	private Long deliveryFulfillmentMode;

	@SerializedName("end_time")
	@OpField(required = false , desc = "限售规则解除时间戳，秒", example= "1736776360")
