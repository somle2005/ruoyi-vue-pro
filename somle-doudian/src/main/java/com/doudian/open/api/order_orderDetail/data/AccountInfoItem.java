...
public class AccountInfoItem {
	...
	@OpField(desc = "买家账号名称", example = "测试")
	private String accountName;

	@SerializedName("account_type")
	@OpField(desc = "买家账号类型;账号类型；枚举值：Mobile-手机号;Email-邮箱 ; IdCard-身份证;  Passport-护照;  BankCard-银行卡;  Number-纯数学;  NumberLetter-数字字母混合;", example = "1")
