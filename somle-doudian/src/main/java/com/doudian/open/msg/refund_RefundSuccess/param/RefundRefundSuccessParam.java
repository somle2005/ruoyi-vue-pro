package com.doudian.open.msg.refund_RefundSuccess.param;
...
public class RefundRefundSuccessParam {


	@SerializedName("p_id")
	@OpField(required = false , desc = "父订单ID", example= "4835702458804229704")
	private Long pId;

	@SerializedName("shop_id")
	@OpField(required = false , desc = "店铺ID", example= "19586871")
	private Long shopId;
	...
	@OpField(required = false , desc = "售后单ID", example= "7000774764214157599")
	private Long aftersaleId;

	@SerializedName("success_time")
	@OpField(required = false , desc = "退款成功时间", example= "1629994938")
	...
	@SerializedName("s_id")
	@OpField(required = false , desc = "子订单ID（售前整单退类型无此字段）", example= "4835702458804229704")
	private Long sId;
	...
	@OpField(required = false , desc = "申请退款的金额（含运费）", example= "24500")
