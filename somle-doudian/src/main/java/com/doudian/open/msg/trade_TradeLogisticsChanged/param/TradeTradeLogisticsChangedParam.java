...
public class TradeTradeLogisticsChangedParam {


	@SerializedName("shop_id")
	@OpField(required = false , desc = "店铺ID，即时零售店铺该字段为即时零售总部id", example= "3032145")
	private Long shopId;
	...
	@SerializedName("p_id")
	@OpField(required = false , desc = "父订单ID", example= "4837108077054598579")
	private Long pId;

	@SerializedName("order_status")
	@OpField(required = false , desc = "父订单状态，发货物流变更消息的status值为3", example= "3")
	...
	@OpField(required = false , desc = "发货物流变更时间", example= "1630373507")
	...
	@OpField(required = false , desc = "子订单ID列表", example= "[4837108077054598579]")
