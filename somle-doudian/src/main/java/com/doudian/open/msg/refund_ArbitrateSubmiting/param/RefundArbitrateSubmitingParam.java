package com.doudian.open.msg.refund_ArbitrateSubmiting.param;
...
public class RefundArbitrateSubmitingParam {
	...
	@OpField(required = false , desc = "仲裁单ID", example= "7001675946843586857_001")
	private String arbitrateId;

	@SerializedName("arbitrate_status")
	@OpField(required = false , desc = "仲裁状态，枚举值如下", example= "4")
	private Long arbitrateStatus;

	@SerializedName("s_id")
	@OpField(required = false , desc = "子订单ID", example= "4832528739960295016")
	private Long sId;

	@SerializedName("p_id")
	@OpField(required = false , desc = "父订单ID", example= "4832528739960295016")
	private Long pId;

	@SerializedName("shop_id")
	@OpField(required = false , desc = "店铺ID", example= "10826557")
	private Long shopId;

	@SerializedName("aftersale_id")
	@OpField(required = false , desc = "售后单ID", example= "7001675946843586857")
